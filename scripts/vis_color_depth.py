...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--start_index", type=int, default=0, help="Start index of images"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="depth",
        help="Type of images to compare with the original group. It can be depth or undistorted",
    )
