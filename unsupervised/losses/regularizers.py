...
# Note that the regularizers contained in this section refer to the ones included
# in the paper section 3.2.1 and 3.2.2. The regularizers in section 3.2.3 are refered to
...
def l1smoothness(tensor, wrap_around=True):
    ...
    This section refers to the one explained in the paper section 3.2.1.
    Args:
...
def sqrt_sparsity(motion_map):
    ...
    `motion_map`.
    This is contained in the section 3.2.1 of the paper as well
    Args:
