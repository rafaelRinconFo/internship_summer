...
def rgbd_consistency_loss(frame1transformed_depth,
    ...
    frames swapped.
    This is the one refered to in 3.2.3 of the paper
    Args:
...
def motion_field_consistency_loss(frame1transformed_pixelx,
    ...
    This one refeers to the section 3.2.3 of the paper. Keep in mind the ´inv´ subindex
    because that's how the paper relates the rotations and translation from the previous 
