...
#         residual_translation = _refine_motion_field(residual_translation, x, self.align_corners, scope='Refine7')
#         residual_translation = _refine_motion_field(residual_translation, x, self.align_corners, scope='Refine6')
#         residual_translation = _refine_motion_field(residual_translation, x, self.align_corners, scope='Refine5')
#         residual_translation = _refine_motion_field(residual_translation, x, self.align_corners, scope='Refine4')
#         residual_translation = _refine_motion_field(residual_translation, x, self.align_corners, scope='Refine3')
#         residual_translation = _refine_motion_field(residual_translation, x, self.align_corners, scope='Refine2')
#         residual_translation = _refine_motion_field(residual_translation, x, self.align_corners, scope='Refine1')
#         residual_translation = _refine_motion_field(residual_translation, x, self.align_corners, scope='RefineImages')
...
#             self.foci = nn.Conv2d(bottleneck.size(3), 2, kernel_size=1)
